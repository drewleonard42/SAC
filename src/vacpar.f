...
INTEGER,PARAMETER:: rho_=1,m0_=rho_,m1_=m0_+1,m2_=m0_+2,m3_=m0_+3,e_=m3_+1 !flow variables
INTEGER,PARAMETER:: ee_=e_, b0_=e_,b1_=b0_+1,b2_=b0_+2,b3_=b0_+3 !flow variables
INTEGER,PARAMETER:: eb_=b3_+1, rhob_=eb_+1
INTEGER,PARAMETER:: bg0_=rhob_, bg1_=bg0_+1,bg2_=bg0_+2,bg3_=bg0_+3
INTEGER,PARAMETER:: nw=bg3_                              ! No. flow variables

INTEGER,PARAMETER:: v0_=m0_, v1_=m1_,v2_=m2_,v3_=m3_, p_=e_, pp_=ee_ !Primitive variables
