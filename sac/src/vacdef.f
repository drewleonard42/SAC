...
!Access Lists
INTEGER :: plist_id, gplist_id, aplist_id
!File id
INTEGER :: file_id
!Groups
INTEGER :: sac_group, time_group
!Attribute dataspaces
INTEGER :: aspace_str, aspace_int, aspace_dbl
INTEGER :: aspace_nx, aspace_eqpar
!hack
LOGICAL :: first_file_write = .TRUE.
...
COMMON /INTE/ unitpar,nerror(nerrcode),kr(3,3),lvc(3,3,3),ixMmin1,ixMmin2,&
   ...
   iwtest,idimtest,plist_id, gplist_id, aplist_id,file_id,sac_group,&
    time_group,aspace_str, aspace_int, aspace_dbl,aspace_nx, aspace_eqpar
