# -*- coding: utf-8 -*-
#
# pySAC documentation build configuration file, created by
# sphinx-quickstart2 on Fri Feb 22 14:45:09 2013.
#
...
project = u'SAC'
copyright = u'2013, University of Sheffield'
...
latex_documents = [
  ('index', 'SAC.tex', u'SAC Documentation',
   u'University of Sheffield', 'manual'),
]
...
man_pages = [
    ('index', 'pysac', u'pySAC Documentation',
     [u'Stuart Mumford'], 1)
]
...
texinfo_documents = [
  ('index', 'SAC', u'SAC Documentation',
   u'Stuart Mumford', 'SAC', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'SAC'
epub_author = u'SWAT'
epub_publisher = u'University of Sheffield'
epub_copyright = u'2013, Univeristy of Sheffield'
